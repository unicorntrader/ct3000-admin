...
export default function UsersScreen() {
  ...
  return (
    <div>
      ...
      {/* Invite links — generated but not auto-sent. Admin delivers manually. */}
      {invites.length > 0 && (
        <div className="mt-8">
          <h2 className="text-sm font-semibold text-gray-700 mb-3">
            Unredeemed invite links
            <span className="text-gray-400 font-normal ml-1.5">({invites.length})</span>
          </h2>
          <p className="text-xs text-gray-400 mb-3">Generated by the admin app — must be delivered to the recipient manually.</p>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
